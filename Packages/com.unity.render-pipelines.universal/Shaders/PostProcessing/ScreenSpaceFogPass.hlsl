#ifndef UNIVERSAL_POSTPROCESSING_SCREEN_SPACE_FOG_PASS_INCLUDED
#define UNIVERSAL_POSTPROCESSING_SCREEN_SPACE_FOG_PASS_INCLUDED

#include "Packages/com.unity.render-pipelines.universal/Shaders/PostProcessing/Fog.hlsl"
...
float4 ScreenSpaceFogPassFragment(Varyings input) : SV_Target
{
    ...
    FogData fd = GetFogData(light.direction);
    float3 color = GetFogColor(fd, rgba.rgb, light.direction, -light.direction,
        viewDir, positionWS, viewPos, input.screenUV);
